...
public class RegistrationPasswordNoConfirmation implements FormAction, FormActionFactory {
  ...
  public String getHelpText() {
    return "Validates password without requiring password confirmation field. Stores password in user's credential store.";
  }
  ...
  public void success(FormContext context) {
    ...
    try {
      user.credentialManager()
          .updateCredential(UserCredentialModel.password(formData.getFirst("password"), false));
    } catch (Exception me) {
  ...
  public String getDisplayType() {
    return "Password Validation (No Confirmation)";
  }
